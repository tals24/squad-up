...
const StatCard = ({ title, value, icon: Icon, linkTo, colorClass }) => (
  <Link to={linkTo} className="block group">
    <Card className={`${DASHBOARD_COLORS.background.card} ${DASHBOARD_COLORS.background.border} shadow-lg ${DASHBOARD_COLORS.effects.hoverShadow} ${DASHBOARD_COLORS.effects.hoverBorder} ${DASHBOARD_COLORS.effects.transition} backdrop-blur-sm`}>
