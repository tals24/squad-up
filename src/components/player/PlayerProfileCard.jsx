  ...
  return (
    <Card className="shadow-2xl border-slate-700 bg-slate-800/70 backdrop-blur-sm">
      <CardContent className="p-6 text-center">
        ...
        <Badge variant="outline" className={`mt-2 ${getPositionBadgeClasses(player.position)} hover:bg-transparent`}>
          {player.position}
        </Badge>
        ...
        <div className="mt-6 space-y-4 text-left">
          ...
          {player.dateOfBirth && (
            <div className="flex items-center gap-4 text-sm">
              ...
              <span className="font-medium text-slate-100">{new Date(player.dateOfBirth).toLocaleDateString()}</span>
            </div>
          )}
          ...
          {player.nationalID && (
            <div className="flex items-center gap-4 text-sm">
              ...
              <span className="font-medium text-slate-100 font-mono text-xs">{player.nationalID}</span>
            </div>
          )}
        </div>
      </CardContent>
