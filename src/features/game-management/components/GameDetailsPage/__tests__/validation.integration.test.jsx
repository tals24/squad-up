...
const mockDataProvider = {
  ...
  players: [
    { _id: '1', fullName: 'John Doe', position: 'goalkeeper', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '2', fullName: 'Mike Smith', position: 'defender', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '3', fullName: 'Tom Wilson', position: 'midfielder', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '4', fullName: 'Alex Brown', position: 'forward', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '5', fullName: 'Chris Davis', position: 'defender', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '6', fullName: 'Sam Johnson', position: 'midfielder', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '7', fullName: 'Ben Miller', position: 'forward', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '8', fullName: 'Dan Garcia', position: 'midfielder', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '9', fullName: 'Luke Martinez', position: 'forward', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '10', fullName: 'Nick Anderson', position: 'defender', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '11', fullName: 'Paul Taylor', position: 'midfielder', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '12', fullName: 'Steve Thomas', position: 'forward', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '13', fullName: 'Mark Jackson', position: 'defender', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '14', fullName: 'Ryan White', position: 'midfielder', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '15', fullName: 'Kevin Harris', position: 'forward', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '16', fullName: 'Tony Martin', position: 'defender', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id },
    { _id: '17', fullName: 'Jake Thompson', position: 'midfielder', team: mockTeam, Team: mockTeam, teamId: mockTeam._id, TeamId: mockTeam._id }
  ],
  teams: [mockTeam],
  gameRosters: [],
  gameReports: [],
...
describe('GameDetails Validation Integration', () => {
  beforeEach(() => {
    ...
    fetch.mockImplementation((url) => {
      if (url.includes('/api/games/game1') && !url.includes('/start-game') && !url.includes('/draft')) {
    ...
    jest.spyOn(require('@/app/providers/DataProvider'), 'useData').mockReturnValue(mockDataProvider);
  });
  ...
  describe('Starting Lineup Validation', () => {
    it('should block "Game Was Played" with incomplete formation', async () => {
      ...
      const mockGameRosters = [
        { _id: 'r1', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[0]._id }, status: 'Starting Lineup' },
        { _id: 'r2', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[1]._id }, status: 'Starting Lineup' },
        { _id: 'r3', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[2]._id }, status: 'Starting Lineup' },
        { _id: 'r4', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[3]._id }, status: 'Starting Lineup' },
        { _id: 'r5', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[4]._id }, status: 'Starting Lineup' },
      ...
      await waitFor(() => {
        const onlyPlayersMessage = /Cannot mark game as played.*Only \d+ players in starting lineup/;
        const noPlayersMessage = /Cannot mark game as played.*No players assigned to starting lineup/;
    ...
    it('should allow "Game Was Played" with complete formation', async () => {
      ...
      const mockGameRosters = [
        ...
        { _id: 'r4', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[3]._id }, status: 'Starting Lineup' },
        { _id: 'r5', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[4]._id }, status: 'Starting Lineup' },
        { _id: 'r6', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[5]._id }, status: 'Starting Lineup' },
        { _id: 'r7', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[6]._id }, status: 'Starting Lineup' },
        { _id: 'r8', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[7]._id }, status: 'Starting Lineup' },
        { _id: 'r9', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[8]._id }, status: 'Starting Lineup' },
        { _id: 'r10', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[9]._id }, status: 'Starting Lineup' },
        { _id: 'r11', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[10]._id }, status: 'Starting Lineup' },
      ...
      fetch.mockResolvedValue({
        ...
        json: () => Promise.resolve({
          data: {
            ...
            rosters: mockGameRosters.map(r => ({ ...r, player: mockDataProvider.players.find(p => p._id === r.player) }))
          }
        })
      });
  ...
  describe('Bench Size Validation', () => {
    it('should show confirmation modal for small bench', async () => {
      ...
      const mockGameRosters = [
        ...
        { _id: 'r12', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[11]._id }, status: 'Bench' },
        { _id: 'r13', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[12]._id }, status: 'Bench' },
        { _id: 'r14', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[13]._id }, status: 'Bench' },
      ];
  ...
  describe('Goalkeeper Validation', () => {
    it('should block "Game Was Played" without goalkeeper', async () => {
      ...
      const mockGameRosters = [
        { _id: 'r1', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[1]._id }, status: 'Starting Lineup' },
        { _id: 'r2', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[2]._id }, status: 'Starting Lineup' },
        { _id: 'r3', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[3]._id }, status: 'Starting Lineup' },
        { _id: 'r4', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[4]._id }, status: 'Starting Lineup' },
        { _id: 'r5', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[5]._id }, status: 'Starting Lineup' },
        { _id: 'r6', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[6]._id }, status: 'Starting Lineup' },
        { _id: 'r7', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[7]._id }, status: 'Starting Lineup' },
        { _id: 'r8', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[8]._id }, status: 'Starting Lineup' },
        { _id: 'r9', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[9]._id }, status: 'Starting Lineup' },
        { _id: 'r10', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[10]._id }, status: 'Starting Lineup' },
        { _id: 'r11', game: { _id: 'game1' }, player: { _id: mockDataProvider.players[11]._id }, status: 'Starting Lineup' },
      ...
      fetch.mockResolvedValue({
        ok: false,
        status: 400,
        json: () => Promise.resolve({ error: 'Starting lineup must include at least one goalkeeper' })
      });
      ...
      await waitFor(() => {
        ...
        const backendMessage = screen.queryByText(/Starting lineup must include at least one goalkeeper/);
