    ...
    <div className="space-y-1">
      ...
      <input
        ...
        className={cn(
          ...
          isUnset ? "[&::-webkit-slider-thumb]:bg-slate-500" : "[&::-webkit-slider-thumb]:bg-cyan-400",
          isUnset ? "[&::-webkit-slider-thumb]:shadow-[0_0_6px_rgba(100,116,139,0.4)]" : "[&::-webkit-slider-thumb]:shadow-[0_0_6px_rgba(34,211,238,0.5)]",
          ...
          isUnset ? "[&::-moz-range-thumb]:shadow-[0_0_6px_rgba(100,116,139,0.4)]" : "[&::-moz-range-thumb]:shadow-[0_0_6px_rgba(34,211,238,0.5)]",
          // Track styling
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          {hasCategoryValues('passing', ['volumeRating', 'accuracyRating', 'keyPassesRating']) && !isReadOnly && (
            <button
              onClick={() => resetCategory('passing', ['volumeRating', 'accuracyRating', 'keyPassesRating'])}
              className="p-1 rounded hover:bg-slate-700/50 text-slate-400 hover:text-slate-200 transition-colors"
