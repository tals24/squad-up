...
The backend follows **professional MVC (Model-View-Controller) architecture** with clear separation of concerns:
- **Routes** (`/api/*`) - Thin routing layer (this document describes these endpoints)
- **Controllers** - HTTP request/response handling and orchestration
- **Services** - Business logic and data processing
- **Models** - Mongoose schemas and database layer

For detailed backend architecture documentation, see `docs/official/backendSummary.md`.
...
- **Backend Architecture:** `docs/official/backendSummary.md` - Complete backend code documentation
- **Database Schema:** `docs/official/databaseArchitecture.md` - Database structure and collections
- **API Guide:** This document - Complete API reference
