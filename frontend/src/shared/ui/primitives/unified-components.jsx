...
export const FormContainer = ({ className, title, description, children, ...props }) => (
...
export const FormSection = ({ className, title, description, children, ...props }) => (
...
export const FormGrid = ({ className, columns = 1, gap = 'md', children, ...props }) => {
  const gaps = {
    sm: 'gap-3',
    md: 'gap-4',
    lg: 'gap-6',
  ...
  return (
    <div className={cn('grid', cols[columns], gaps[gap], className)} {...props}>
      {children}
    </div>
  );
};
...
export const Textarea = React.forwardRef(
  ({ className, size = 'md', error, rows = 4, ...props }, ref) => {
    const baseClasses = [
...
export const Select = React.forwardRef(
  (
    { className, size = 'md', error, children, placeholder = 'Select an option', ...props },
    ref
  ) => {
    const baseClasses = [
      'flex w-full rounded-lg border bg-white px-3 text-neutral-900',
...
export const FormAlert = ({ className, variant = 'info', title, children, onClose, ...props }) => {
  const variants = {
    info: {
  ...
  return (
    <div className={cn('rounded-lg border p-4', container, className)} {...props}>
      <div className="flex">
