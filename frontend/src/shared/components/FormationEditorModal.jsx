      ...
      <DialogContent className="sm:max-w-md bg-card border-border text-card-foreground">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label htmlFor="defenders" className="flex items-center gap-2">
                <Shield className="w-4 h-4 text-blue-400" /> Defenders
              </Label>
              <Input
                id="defenders"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="midfielders" className="flex items-center gap-2">
                <Users className="w-4 h-4 text-green-400" /> Midfielders
              </Label>
              <Input
                id="midfielders"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="forwards" className="flex items-center gap-2">
                <Swords className="w-4 h-4 text-red-400" /> Forwards
              </Label>
              <Input
                id="forwards"
                type="number"
