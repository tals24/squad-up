...
describe('ConfirmationModal', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should display custom button text', () => {
      render(<ConfirmationModal {...defaultProps} confirmText="Continue" cancelText="Go Back" />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long title and message', () => {
      ...
      render(<ConfirmationModal {...defaultProps} title={longTitle} message={longMessage} />);
