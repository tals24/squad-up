  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div>
        ...
        <Select value={foulsCommitted} onValueChange={onFoulsCommittedChange} disabled={isReadOnly}>
          ...
          <SelectContent className="bg-slate-800 border-slate-700">
            ...
            <SelectItem value="1-2" className="text-white">
              1-2
            </SelectItem>
            <SelectItem value="3-4" className="text-white">
              3-4
            </SelectItem>
      ...
      <div>
        ...
        <Select value={foulsReceived} onValueChange={onFoulsReceivedChange} disabled={isReadOnly}>
          <SelectTrigger className="bg-slate-800 border-slate-700 text-white">
            <SelectValue placeholder="Select range" />
          </SelectTrigger>
          <SelectContent className="bg-slate-800 border-slate-700">
